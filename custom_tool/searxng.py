...
def search_searxng(query):
    ...
    params = {"q": query, "categories": api_categories}
    ...
    for result in soup.find_all("article", class_="result"):
        if api_categories == "images":
            ...
            results.append({"image": img_src, "link": link, "snippet": snippet})
...
if language == "zh_CN" or language == "en_US":
    lang = language
if lang == "zh_CN":
    NODE_DISPLAY_NAME_MAPPINGS = {"searxng_tool": "searxng搜索工具"}
else:
    NODE_DISPLAY_NAME_MAPPINGS = {"searxng_tool": "searxng Search Tool"}
