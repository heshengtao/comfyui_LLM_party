...
1. Lors de la fête comfyui LLM, le système de fraises du modèle de la série chatgpt-o1 a été reproduit, en se référant aux invites de [Llamaberry](https://huggingface.co/spaces/martinbowling/Llamaberry/blob/main/app.py). Exemple de flux de travail : [Système de fraises comparé à o1](workflow\草莓系统与o1对比.json).
