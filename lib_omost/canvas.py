...
class Canvas:
    ...
    def set_global_description(
        self, description: str, detailed_descriptions: list[str], tags: str, HTML_web_color_name: str
    ):
    ...
    def add_local_description(
        ...
        self.components.append(
            dict(rect=rect, distance_to_viewer=distance_to_viewer, color=color, prefixes=prefixes, suffixes=suffixes)
        )
