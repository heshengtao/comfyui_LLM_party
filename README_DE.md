...
## Neueste Updates
1. Ein neues Browser-Tool wurde auf der Grundlage von [browser-use](https://github.com/gregpr07/browser-use) entwickelt, das es LLM ermöglicht, die von Ihnen veröffentlichten Browser-Aufgaben automatisch auszuführen.
