...
1. Adicionado o nó EasyOCR para reconhecer texto e posições em imagens. Ele pode gerar máscaras correspondentes e retornar uma string JSON para visualização pelo LLM. Existem versões padrão e premium disponíveis para todos escolherem!
