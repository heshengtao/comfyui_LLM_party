    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "api_name": (["/generate_audio", "/generate_audio_1","/generate_audio_2"], {"default": "/generate_audio"}),
                "voice": (['中文女', '中文男', '英文女', '英文男', '日语男', '粤语女', '韩语女'], {"default": '中文女'}),
            },
        }
