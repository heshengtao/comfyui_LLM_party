...
[super-agent-party](https://github.com/heshengtao/super-agent-party) は、新世代のインテリジェントエンティティ管理プラットフォームです！ワンクリックで、LLM APIをエージェントAPIにアップグレードできます！また、ワンクリックでソーシャルソフトウェアにデプロイすることも可能です！
![image](img/demo.png)
