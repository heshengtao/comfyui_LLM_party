...
1. Добавлен инструмент управления локальными файлами, который позволяет LLM управлять файлами в указанной вами папке, например, читать, записывать, добавлять, удалять, переименовывать, перемещать и копировать файлы.
