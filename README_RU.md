...
1. Стандартный совместимый сервис хостинга изображений party был обновлён до домена [imgbb](https://imgbb.io), так как предыдущий сервис хостинга изображений был не очень удобен для пользователей материкового Китая и поэтому был заменён.
