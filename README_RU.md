...
1. Добавлен узел EasyOCR для распознавания текста и позиций на изображениях. Он может создавать соответствующие маски и возвращать строку JSON для просмотра LLM. Доступны стандартная и премиум-версии на выбор!
