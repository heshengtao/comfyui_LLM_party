...
## Быстрый старт
1. Добавлен инструмент [searxng](https://github.com/searxng/searxng), который может агрегировать поисковые запросы по всему интернету. Perplexica также полагается на этот инструмент агрегирования поиска, так что вы можете настроить Perplexica на своей вечеринке. Вы можете развернуть публичный образ searxng/searxng в Docker, затем запустить его с помощью `docker run -d -p 8080:8080 searxng/searxng` и получить доступ к нему, используя `http://localhost:8080`. Вы можете ввести этот URL `http://localhost:8080` в инструмент searxng на вечеринке, и тогда вы сможете использовать searxng как инструмент для LLM.
...
2. Если у вас возникли проблемы с плагином или у вас есть другие вопросы, присоединяйтесь к нашей группе QQ: [931057213](img/Q群.jpg) |discord：[discord](https://discord.gg/bsnMfMAv).
...
3. discord:[дискорд-ссылка](https://discord.gg/bsnMfMAv)
