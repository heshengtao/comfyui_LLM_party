...
[super-agent-party](https://github.com/heshengtao/super-agent-party) — это платформа управления интеллектуальными сущностями нового поколения! Всего однимclick вы можете обновить свой LLM API до Agent API! И вы можете развернуть его в социальных программах всего однимclick!
![image](img/demo.png)
