...
[super-agent-party](https://github.com/heshengtao/super-agent-party) هو جيل جديد من منصة إدارة الكيانات الذكية! بنقرة واحدة فقط، يمكنك ترقية واجهة برمجة التطبيقات LLM الخاصة بك إلى واجهة برمجة التطبيقات Agent! ويمكنك نشرها على البرامج الاجتماعية بنقرة واحدة فقط!
![image](img/demo.png)
