...
## التحديثات الأخيرة
1. في حفلة comfyui LLM، تم إعادة إنتاج نظام الفراولة لنموذج سلسلة chatgpt-o1، بالإشارة إلى مطالبات [Llamaberry](https://huggingface.co/spaces/martinbowling/Llamaberry/blob/main/app.py). مثال على سير العمل: [نظام الفراولة مقارنة بـ o1](workflow\草莓系统与o1对比.json).
