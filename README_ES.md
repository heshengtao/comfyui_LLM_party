...
1. La opción de imagen compatible por defecto de party ha sido actualizada al dominio [imgbb](https://imgbb.io), ya que el anterior alojamiento de imágenes no era amigable para los usuarios de China continental y ha sido reemplazado.
