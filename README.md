...
## Latest Updates
1. At present, [ComfyUI-Custom-Scripts](https://github.com/pythongosssss/ComfyUI-Custom-Scripts) has a bug, which will lock the input component switching function of the node, and after testing, rolling back the plugin to a version before 2023.08.19 can avoid this bug.
